  ...
  return (
    <>
      ...
      <a class="navbar-brand ms-4" href="#">
        ...
        <div>
        <button type="button" class="btn btn-outline-primary mx-3 btn-lg">Skincare</button>
        <button type="button" class="btn btn-outline-primary mx-3 btn-lg">Maquillaje</button>
        <button type="button" class="btn btn-outline-primary mx-3 btn-lg">Cabello</button>
        </div>
        <CartWidget />
        </div>
