...
<Link to={'/Home'} >
      <img
          ...
          alt="marca" width="50px"
        />
     </Link> 
        <div>
        <button type="button" class="btn btn-outline-primary mx-3 btn-lg"><Link to={'/Home'}>Home</Link></button>
        <button type="button" class="btn btn-outline-primary mx-3 btn-lg"><Link to={'/Skincare'}>Skincare</Link></button>
        <button type="button" class="btn btn-outline-primary mx-3 btn-lg"><Link to={'/Maquillaje'}>Maquillaje</Link></button>
        <button type="button" class="btn btn-outline-primary mx-3 btn-lg"><Link to={'/Cabello'}>Cabello</Link></button>
